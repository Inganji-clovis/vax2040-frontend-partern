...
import { medicalSupplyFormConfig } from '../../../../data/dataDonationFormsConfig';

export default function MedicalSupplyFormPage() {
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 40px' }}>
        ...
        <div style={{ marginBottom: '36px' }}>
          ...
          <p style={{ fontSize: '1rem', color: '#64748B', lineHeight: 1.7 }}>
            {medicalSupplyFormConfig.introText}
          </p>
        </div>

        <DataDonationForm config={medicalSupplyFormConfig} />
      </div>
    </div>
  );
}
