    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftSide}>
        <div className={styles.leftContent}>
          ...
          <h1 className={styles.projectTitle}>VAX2040</h1>
        ...
        <div className={styles.rightContent}>
          ...
          {mode === 'signin' && !codeSent && (
            <form onSubmit={handleSendCode} className={styles.form}>
              ...
              <div className={styles.field}>
                <label className={styles.label}><IconBuilding /> Choose Access / Organisation</label>
          ...
          {mode === 'register' && !regSubmitted && (
            <form onSubmit={handleRegister} className={styles.form}>
              <h2 className={styles.formTitle}>Request Partner Access</h2>
